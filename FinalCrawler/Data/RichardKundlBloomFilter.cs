...
{
    public class RichardKundlBloomFilter : IBloomFilter
    {
        ...
        public RichardKundlBloomFilter(int capacity)
            : this(capacity, null)
        {
        }
        ...
        public RichardKundlBloomFilter(int capacity, float errorRate)
        ...
        public RichardKundlBloomFilter(int capacity, HashFunction hashFunction)
        ...
        /// <param name="errorRate">The accepable false-positive rate (e.g., 0.01F = 1%)</param>
        /// <param name="hashFunction">The function to hash the input values. Do not use GetHashCode(). If it is null, and T is string or int a hash function will be provided for you.</param>
        public RichardKundlBloomFilter(int capacity, float errorRate, HashFunction hashFunction)
        ...
        public RichardKundlBloomFilter(int capacity, float errorRate, HashFunction hashFunction, int m, int k)
        {
